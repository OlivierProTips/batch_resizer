...
def parseAndResize(_dest_folder: str, _percent: int, verbose=False):
...
if "__main__" == __name__:
	...
	_dest_folder = copyImagesFolder(_src_folder, _dest_folder)
	parseAndResize(_dest_folder, _percent, args.verbose)